...
void DDUpdateUploadServer::setup(ESP8266WebServer *server, const String &path, const String &username, const String &password)
{
  ...
  _server->on("/upload", HTTP_POST, [&]() { _server->send(200, "text/plain", "Upload POST success!"); }, [&]() {
